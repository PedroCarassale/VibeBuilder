    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.create_project_initial_prompt_label)) },
                placeholder = {
                    Text(stringResource(R.string.create_project_initial_prompt_placeholder))
                },
                isError = state.promptError != null,
                supportingText = state.promptError?.let { { Text(it) } },
                minLines = 4,
                modifier = Modifier
                    .fillMaxWidth()
                    .heightIn(min = 140.dp)
